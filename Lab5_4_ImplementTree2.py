...
def add_nodes(t):
    t._add_root('0')
    t._add_left(t.root(), '1')
    t._add_right(t.root(), '2')
...
T._attach(nodes[3], t1, t2)
print('# T:', len(T))
print('3 left child:', T.left(nodes[3]).element())
print('3 right child:', T.right(nodes[3]).element())
